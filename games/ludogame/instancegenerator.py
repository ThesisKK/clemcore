...
class LudoInstanceGenerator(GameInstanceGenerator):
    ...
    def _generate_experiment(
        ...
        experiment: dict = self.add_experiment(f'{experiment_name}_COT={chain_of_thought}_Reprompt={reprompt}_NoBoard={no_board}_NUM_TOKENS={num_tokens}')
