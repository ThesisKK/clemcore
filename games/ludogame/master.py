...
from games.ludogame.game import Game
from games.ludogame.player import LudoPlayer, parse_text
from games.ludogame.scoring import LudoGameScorer
...
class LudoGameMaster(GameMaster):
    ...
    def __init__(
        ...
        # rewrite the following line to use the new error handling
        self.error: Union[tuple[str, Union[str, None]], None] = None
    ...
    def _check_game_status(self) -> Union[str, bool]:
        """
...
if __name__ == "__main__":
    ...
    experiment_name: Union[str, None] = "multiplayer"
