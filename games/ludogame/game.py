...
from games.ludogame.player import HumanPlayer, LudoPlayer, ProgrammaticPlayer
from typing import Union, Optional


GAME_NAME: str = "ludogame"

logger: logging.Logger = get_logger("games.ludogame.game")
...
class Game:
    ...
    def __init__(
        ...
        n_fields: int,
        n_tokens: int,
        rolls: list[Union[tuple[int, int], int]],
        ...
        self.turn: int = 0
        self.rolls: list[Union[tuple[int, int], int]] = rolls

        # Initializes then loads in players
        self.player_1: Optional[LudoPlayer] = None
        self.player_2: Optional[Union[HumanPlayer, ProgrammaticPlayer]] = None
    ...
    def reprompt(self, error_type: str, msg, token: Optional[str] = None) -> None:
        """
