...
from games.ludogame.minimax import GameSim, minimax
...
class LudoPlayer(Player):
    ...
    def __init__(
            self,
            model: Union[CustomResponseModel, HumanModel, Model],
            n_tokens: int
    ) -> None:
        """
...
class ProgrammaticPlayer(LudoPlayer):
    ...
    def _parse_messages(
        ...
        """
        pattern_match: Union[re.Match, None] = GM_PATTERN.search(input_message)
